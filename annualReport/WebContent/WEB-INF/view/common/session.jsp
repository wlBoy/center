...
<head>
    ...
    <title>年终总结报告系统-session过期页面</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
	                        <div style="width:100%;height:600px;text-align:center;line-height:600px;">
	                        	账户未正常登录或已过期！请点击<a href="/login">重新登录</a>
	                        </div>
                        </div>
                    </div>
                </div>
