                ...
                <div class="panel panel-default">
                    ...
                    <form id="data">
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>101-120</td>
                                        <td  rowspan="4"><input id="pm" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.PM}</c:if>" readonly="readonly"></td>
                                        <td  rowspan="4"><input id="truepm" class="form-control"  readonly="readonly"></td>
                                        <td  rowspan="4">
                                            <div class="form-group">
                                                <input type="text" id="depPM" name="pm" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.DEP_PM}</c:if>" onchange="getScore('depPM',0.1,'depSum')">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>101-120</td>
                                        <td  rowspan="4"><input id="ic" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.IC}</c:if>" readonly="readonly"></td>
                                        <td  rowspan="4"><input id="trueic" class="form-control"  readonly="readonly"></td>
                                        <td  rowspan="4">
                                            <div class="form-group">
                                                <input id="depIC" name="ic" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.DEP_IC}</c:if>" onchange="getScore('depIC',0.2,'depSum')">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>101-120</td>
                                        <td  rowspan="4"><input id="sv" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.SV}</c:if>" readonly="readonly"></td>
                                        <td  rowspan="4"><input id="truesv" class="form-control"  readonly="readonly"></td>
                                        <td  rowspan="4">
                                            <div class="form-group">
                                                <input id="depSV" name="sv" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.DEP_SV}</c:if>" onchange="getScore('depSV',0.2,'depSum')">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>101-120</td>
                                        <td  rowspan="4"><input id="rp" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.RP}</c:if>" readonly="readonly"></td>
                                        <td  rowspan="4"><input id="truerp" class="form-control"  readonly="readonly"></td>
                                        <td  rowspan="4">
                                            <div class="form-group">
                                                <input id="depRP" name="rp" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.DEP_RP}</c:if>" onchange="getScore('depRP',0.1,'depSum')">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>101-120</td>
                                        <td  rowspan="4"><input id="sd" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.SD}</c:if>" readonly="readonly"></td>
                                        <td  rowspan="4"><input id="truesd" class="form-control"  readonly="readonly"></td>
                                        <td  rowspan="4">
                                            <div class="form-group">
                                                <input id="depSD" name="sd" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.DEP_SD}</c:if>" onchange="getScore('depSD',0.1,'depSum')">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>101-120</td>
                                        <td  rowspan="4"><input id="ts" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.TS}</c:if>" readonly="readonly"></td>
                                        <td  rowspan="4"><input id="truets" class="form-control"  readonly="readonly"></td>
                                        <td  rowspan="4">
                                            <div class="form-group">
                                                <input id="depTS" name="ts" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.DEP_TS}</c:if>" onchange="getScore('depTS',0.1,'depSum')">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>101-120</td>
                                        <td  rowspan="4"><input id="si" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.SI}</c:if>" readonly="readonly"></td>
                                        <td  rowspan="4"><input id="truesi" class="form-control"  readonly="readonly"></td>
                                        <td  rowspan="4">
                                            <div class="form-group">
                                                <input id="depSI" name="si" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.DEP_SI}</c:if>" onchange="getScore('depSI',0.1,'depSum')">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>101-120</td>
                                        <td  rowspan="4"><input id="cw" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.CW}</c:if>" readonly="readonly"></td>
                                        <td  rowspan="4"><input id="truecw" class="form-control"  readonly="readonly"></td>
                                        <td  rowspan="4">
                                            <div class="form-group">
                                                <input id="depCW" name="cw" class="form-control"  value="<c:if test="${not empty selfAssessment }">${selfAssessment.DEP_CW}</c:if>" onchange="getScore('depCW',0.1,'depSum')">
                                            </div>
                                        </td>
                            ...
                            <div class="form-group">
                                <label>优秀典型事例</label>
                                <textarea class="form-control" id="excellentExamples"  rows="10" readonly="readonly"><c:if test="${not empty selfAssessment }">${selfAssessment.EXCELLENT_EXAMPLES}</c:if></textarea>
                            </div>
                            <div class="form-group">
                                <label>自我评语</label>
                                <textarea class="form-control" id="selfComment"  rows="10" readonly="readonly"><c:if test="${not empty selfAssessment }">${selfAssessment.SELF_COMMENT}</c:if></textarea>
                            </div>
                            <div class="form-group">
                                <label>上级评语</label>
                                <textarea class="form-control" id="leaderComment" name="leaderComment" rows="10" placeholder="请填写上级评语"><c:if test="${not empty selfAssessment }">${selfAssessment.LEADER_COMMENT}</c:if></textarea>
                            </div>
                            <div class="form-group">
                                <label>横向部门评语</label>
                                <textarea class="form-control" id="departmentComment" name="departmentComment" rows="10" placeholder="请填写横向部门评语"><c:if test="${not empty selfAssessment }">${selfAssessment.DEPARTMENT_COMMENT}</c:if></textarea>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <label><input type="radio" class="radio-button" name="reviewLevel" value="A" <c:if test="${ selfAssessment.REVIEW_LEVEL=='A'}">checked="checked"</c:if>>A</label>
                                                <label><input type="radio" class="radio-button" name="reviewLevel" value="B" <c:if test="${ selfAssessment.REVIEW_LEVEL=='B'}">checked="checked"</c:if>>B</label>
                                                <label><input type="radio" class="radio-button" name="reviewLevel" value="C" <c:if test="${ selfAssessment.REVIEW_LEVEL=='C'}">checked="checked"</c:if>>C</label>
                                                <label><input type="radio" class="radio-button" name="reviewLevel" value="D" <c:if test="${ selfAssessment.REVIEW_LEVEL=='D'}">checked="checked"</c:if>>D</label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <label><input type="radio" class="radio-button" name="reviewResult" value="1" <c:if test="${ selfAssessment.REVIEW_RESULT==1}">checked="checked"</c:if>>留用</label>
                                                <label><input type="radio" class="radio-button" name="reviewResult" value="2" <c:if test="${ selfAssessment.REVIEW_RESULT==2}">checked="checked"</c:if>>晋升</label>
                                                <label><input type="radio" class="radio-button" name="reviewResult" value="3" <c:if test="${ selfAssessment.REVIEW_RESULT==3}">checked="checked"</c:if>>推优</label>
                                                <label><input type="radio" class="radio-button" name="reviewResult" value="4" <c:if test="${ selfAssessment.REVIEW_RESULT==4}">checked="checked"</c:if>>其他</label>
                                            </div>
                                        </td>
...
<script>
    ...
    $('#selfAssessmentBtn').click(function () {
        ...
        var pmScore = $('#depPM').val();
        var icScore = $('#depIC').val();
        var svScore = $('#depSV').val();
        var rpScore = $('#depRP').val();
        var sdScore = $('#depSD').val();
        var tsScore = $('#depTS').val();
        var siScore = $('#depSI').val();
        var cwScore = $('#depCW').val();
        var result = $('input[name="reviewResult"]').filter(':checked').val();
        var reviewLevel = $('input[name="reviewLevel"]').filter(':checked').val();
        var leaderComment = $('#leaderComment').val();
        var departmentComment = $('#departmentComment').val();
        var assessmentId = $('#assessmentId').val();

        if (pmScore !== '' && icScore !== '' && svScore !== '' && rpScore !== '' && sdScore !== '' && tsScore !== '' &&
            siScore !== '' && cwScore !== '' && result !== '' && reviewLevel !== '') {
            if (window.confirm("您确认提交吗？")) {
                $.post('self?op=saveDepAssessment', {
