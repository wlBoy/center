...
public class StringUtil {
	...
	public static String replaceZiFu(String str) {
		String after = str.replaceAll("-", "").replaceAll(" ", "")
				.replaceAll(":", "");
		return after;
	}
	...
	public static String findFromString(String str, String regEx,
			String groupIndex) {
	...
	public static String findFromString(String str, String regEx,
			String groupIndex, boolean ignoreCase) {
		if (StringUtil.isNullValue(str))
			return null;
	...
	public static final String getParameterValue(String argsList, String key) {
		...
		String value = StringUtil
				.findFromString(argsList, reg.concat("&"), "1");
		if (value != null)
			return value;
		value = StringUtil.findFromString(argsList,
				"&".concat(reg).concat("&"), "1");
		if (value != null)
			return value;
		value = StringUtil.findFromString(argsList,
	...
	/**
	 * 将post请求的json形式参数转换为get请求的URL拼接形式参数
	 * 
	 * @param json
	 *            post请求的json形式参数字符串
	 * @return get请求的URL拼接形式参数字符串
	 */
	public static String postRequestString2GetRequestString(String json) {
		String result = "";
		String[] array = json.replace("{", "").replace("}", "")
				.replace("\"", "").split(",");
	...
	public static void main(String[] args) {
		// System.out.println(getStrWithSameElement(7,"13606512273"));
		try {
			getGidRandom();
		} catch (Exception e) {
