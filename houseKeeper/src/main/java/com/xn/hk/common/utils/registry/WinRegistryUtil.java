package com.xn.hk.common.utils.registry;
...
public class WinRegistryUtil {
	...
	/**
	 * Method removes the trailing \0 which is returned from the java.dll (just if
	 * the last sign is a \0)
	 * 
	...
	public static void main(String[] args)
			throws IllegalArgumentException, IllegalAccessException, InvocationTargetException, IOException {
		String hex = WinRegistryUtil.valueForKey(WinRegistryUtil.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Network\\Media",
				"MediaManager");
		System.out.println(hex);
		System.out.println("======================");
		Map<String, String> map = WinRegistryUtil.valuesForPath(WinRegistryUtil.HKEY_LOCAL_MACHINE,
				"SOFTWARE\\Microsoft\\Office\\16.0\\Access Connectivity Engine\\Engines");
		for (String key : map.keySet()) {
			System.out.println(key + "-" + map.get(key));
		}
		System.out.println("======================");
		String val = WinRegistryUtil.valueForKeyPath(WinRegistryUtil.HKEY_LOCAL_MACHINE, "SYSTEM", "SkuPolicyRequired");
