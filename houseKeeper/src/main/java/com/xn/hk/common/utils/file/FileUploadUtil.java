...
import com.xn.hk.common.exception.file.FileNameLengthLimitExceededException;
import com.xn.hk.common.exception.file.FileSizeLimitExceededException;
import com.xn.hk.common.exception.file.InvalidExtensionException;
...
public class FileUploadUtil
{
    ...
    public static final String extractFilename(MultipartFile file)
    {
        ...
        fileName = DateUtil.formatDate() + "/" + encodingFilename(fileName) + "." + extension;
        return fileName;
    }
    ...
    private static final String encodingFilename(String fileName)
    {
        ...
        fileName = HashUtil.encryptStr(fileName + System.nanoTime() + counter++);
        return fileName;
    }
